...
bin/pulsar-admin tenants create partner-lifecycle || echo "Tenant ya existe"
bin/pulsar-admin namespaces create partner-lifecycle/events || echo "Namespace ya existe"

# Crear topics para eventos de partnerships
bin/pulsar-admin topics create persistent://partner-lifecycle/events/partner-events || echo "Topic partner-events ya existe"
